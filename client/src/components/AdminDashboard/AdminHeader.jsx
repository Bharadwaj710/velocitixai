    ...
    <header className="bg-white shadow-sm border-b sticky top-0 z-50 h-14 sm:h-16">
      <div className="h-full px-3 sm:px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2">
          <h1 className="text-xl font-semibold text-transparent bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text">
            Admin Dashboard
          </h1>
        </div>
            ...
            <button
              onClick={() => {
                window.dispatchEvent(
                  new CustomEvent("navigateToRecentActivity")
                );
                setShowNotifications(false);
              }}
                ...
                <div>
                  <button
                    onClick={() => {
                      setSidebarOpen(false);
                      window.dispatchEvent(
                        new CustomEvent("navigateToSettings")
                      );
                      setShowProfileMenu(false);
                    }}
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 border-t flex items-center"
                  >
